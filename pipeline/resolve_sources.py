...
CURATED: list[dict] = [
  ...
  dict(id="nopriors", name="No Priors", zh="No Priors", cat="ai", tier=1, lang="en",
       itunes=1668002688, feed="https://feeds.megaphone.fm/nopriors", residential=True, desc="Sarah Guo 与 Elad Gil 对 AI 创业者的投资人式追问"),
  dict(id="a16z", name="The a16z Show", zh="a16z", cat="ai", tier=2, lang="en",
       itunes=842818711, feed="https://feeds.simplecast.com/JGE3yC0V", residential=True, desc="a16z 的行业趋势与投资视角"),
  ...
  dict(id="interconnects", name="Interconnects", zh="Interconnects", cat="ai", tier=1, lang="en",
       # **不要写 itunes id。** 1719789201 是 AI & I 的，写在这里的后果是
       # `--check` 每一轮都按它重新解析，把下面这个正确的 Substack 地址
       # 覆盖成 AI & I 的 feed —— 于是 tier1 的「Interconnects」槽位里
       # 装的是别人的节目，Nathan Lambert 的内容从来没进过库，
       # 而近 30 天它「4 集里 3 集判成重复、0 篇发布」，看起来像这档源不产出。
       feed="https://api.substack.com/feed/podcast/48206.rss", residential=True, desc="Nathan Lambert 的后训练与开源模型分析，技术判断少有水分"),
  dict(id="trainingdata", name="Training Data", zh="Training Data", cat="ai", tier=2, lang="en",
       itunes=1750736528, feed="https://feeds.megaphone.fm/trainingdata", residential=True, desc="Sequoia 的 AI 研究与创业访谈"),
  ...
  dict(id="madpod", name="The MAD Podcast", zh="MAD Podcast", cat="ai", tier=2, lang="en",
       itunes=1702572539, feed="https://anchor.fm/s/f2ee4948/podcast/rss", residential=True, desc="Matt Turck 的数据与 AI 基础设施访谈"),
  ...
  dict(id="mlst", name="Machine Learning Street Talk", zh="ML Street Talk", cat="ai", tier=2, lang="en",
       itunes=1510472996, feed="https://anchor.fm/s/1e4a0eac/podcast/rss", residential=True, desc="最硬的学术辩论场，常有和主流叙事对立的观点"),
  ...
  dict(id="deepmind", name="Google DeepMind: The Podcast", zh="Google DeepMind", cat="ai", tier=2, lang="en",
       ...
       residential=True, desc="DeepMind 官方，更新慢但都是一手研究"),
  ...
  dict(id="lex", name="Lex Fridman Podcast", zh="Lex Fridman", cat="ai", tier=2, lang="en",
       ...
       residential=True, desc="超长访谈，选题跨 AI、科学与政治"),
  ...
  dict(id="ilt", name="Invest Like the Best", zh="Invest Like the Best", cat="biz", tier=1, lang="en",
       ...
       residential=True, desc="Patrick O'Shaughnessy 与一线投资人、创始人的长谈"),
  ...
  dict(id="sharptech", name="Sharp Tech", zh="Sharp Tech", cat="biz", tier=1, lang="en",
       itunes=1616249586, feed="https://sharptech.fm/feed/podcast", residential=True, desc="Ben Thompson 的战略分析，聚合理论的原产地"),
  dict(id="allin", name="All-In Podcast", zh="All-In", cat="biz", tier=2, lang="en",
       itunes=1502871393, feed="https://rss.libsyn.com/shows/254861/destinations/1928300.xml", residential=True, desc="四位投资人的周谈，观点强、噪音也大"),
  ...
  dict(id="twist", name="This Week in Startups", zh="This Week in Startups", cat="biz",
       ...
       residential=True, desc="创始人与投资人一手对话，更新极密"),
